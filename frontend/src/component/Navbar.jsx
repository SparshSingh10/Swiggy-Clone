            ...
            <div className="flex items-center px-6 pt-6">
                {user ? (
                    <div className="flex items-center">
                        <div className="text-black mr-3">Welcome, {user.firstName}</div>
                        <button onClick={handleLogout} className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Log Out</button>
                    </div>
                ) : (
                    <NavLink to="/login"><button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Log-in</button></NavLink>
                )}
            </div>
        </div>
    );
