    ...
    return (
        <div className="relative bg-[url('https://b.zmtcdn.com/web_assets/81f3ff974d82520780078ba1cfbd453a1583259680.png')] bg-no-repeat bg-cover min-h-screen">
            ...
            <div className='mx-auto pt-20 rounded-lg p-4 pt-1 w-2/4 relative z-10 overflow-hidden'>
                ...
                {flag ? <LoginForm handleSubmit1={handleSubmit1} handleLoginEmail={handleLoginEmail} handleLoginPassword={handleLoginPassword} /> : <SignUpForm handleInputChange={handleInputChange} handleSubmit={handleSubmit} />}
            </div>
        </div>
    );
}

function LoginForm({ handleSubmit1, handleLoginEmail, handleLoginPassword }) {
    return (
